...
namespace plugin {
                            ...
                            if ((material->materialAlpha < 0.0001f ||
                                 ((((RE::BSLightingShaderMaterialBase*) material)->diffuseTexture &&
                                   ((((RE::BSLightingShaderMaterialBase*) material)->diffuseTexture->name.contains("\\default.dds")) ||
                                    (((RE::BSLightingShaderMaterialBase*) material)->diffuseTexture->name.contains("\\blank.dds"))))))) {
    ...
    void GameEventHandler::onDataLoaded() {
        ...
        if (ini["OverlayFix"]["hideunusedoverlays"] == "true") {
            do_hide_unused_overlays = true;
        }
        ...
        if (HMODULE handle = GetModuleHandleA("skee64.dll")) {
            ...
            if (skee_loaded.compare_exchange_strong(expected, 1) == true && expected == 0) {
                ...
                if ((skee64_info.SizeOfImage >= 0xc2950 + 0x40) &&
                    ...
                    nullSkeletonFix = new SKEENullFix((uint64_t) ((uintptr_t) skee64_info.lpBaseOfDll + (uintptr_t) 0xd97a0));
                    const uint8_t* nullSkeletonCode = nullSkeletonFix->getCode();
                    REL::safe_write(((uintptr_t) skee64_info.lpBaseOfDll + (uintptr_t) 0x1e8500), (uint8_t*) (&nullSkeletonCode),
                                    sizeof(uint64_t));
                    if (ini["OverlayFix"]["reverse"] == "default") {
                        do_reverse = true;
                    }
                    ...
                    if (OverlayHook == 0x0) {
                        OverlayHook =
                            (void (*)(void* inter, uint32_t param_2, uint32_t param_3, RE::TESObjectREFR* param_4, RE::NiNode* param_5,
                                      RE::NiAVObject* param_6))((uint64_t) skee64_info.lpBaseOfDll + 0xd5d20);
                        OverlayHook2 =
                            (void (*)(void* inter, uint32_t param_2, uint32_t param_3, RE::TESObjectREFR* param_4, RE::NiNode* param_5,
                                      RE::NiAVObject* param_6))((uint64_t) skee64_info.lpBaseOfDll + 0xd5e70);
                        InstallOverlayHook = (void (*)(void* inter, const char* param_2, const char* param_3, RE::TESObjectREFR* param_4,
                                                       RE::BSGeometry* geo, RE::NiNode* param_5,
                                                       RE::BGSTextureSet* param_6))((uint64_t) skee64_info.lpBaseOfDll + 0xd3f40);
                        DetourTransactionBegin();
                        DetourUpdateThread(GetCurrentThread());
                        DetourAttach(&(PVOID&) InstallOverlayHook, &InstallOverlayHook_fn);
                        DetourTransactionCommit();
                    ...
                    SetShaderPropertyHook = (void (*)(RE::NiAVObject* obj, void* variant, bool immediate, uint64_t arg4))(
                        (uint64_t) skee64_info.lpBaseOfDll + 0x12d060);
                    DetourTransactionBegin();
                    DetourUpdateThread(GetCurrentThread());
                    DetourAttach(&(PVOID&) SetShaderPropertyHook, &SetShaderProperty_fn);
                    DetourTransactionCommit();
                    if (PARALLEL_TRANSFORM_FIX) {
                        logger::info("SKEE64 0.4.20.0 parallel node transform workaround applying");
                        nitransforminterface = (void*) (((uint64_t) skee64_info.lpBaseOfDll) + 0x2388b0);
                        UpdateNodeTransformsHook = (void (*)(void*, RE::TESObjectREFR*, bool, bool, const SKEEString* node_name))(
                            (uint64_t) skee64_info.lpBaseOfDll + 0xca430);
                        DetourTransactionBegin();
                        DetourUpdateThread(GetCurrentThread());
                        DetourAttach(&(PVOID&) UpdateNodeTransformsHook, &UpdateNodeTransformsHook_fn);
                        DetourTransactionCommit();
                        ...
                        SetNodeTransformsHook = (void (*)(void* arg1, uint32_t formID, uint64_t immediate, bool reset))(
                            (uint64_t) skee64_info.lpBaseOfDll + 0xcae20);
                        DetourTransactionBegin();
                        DetourUpdateThread(GetCurrentThread());
                        DetourAttach(&(PVOID&) SetNodeTransformsHook, &SetNodeTransformsHook_fn);
                        DetourTransactionCommit();
                        ...
                        SkeletonOnAttachHook = (void (*)(void* arg1, void* arg2, void* arg3, void* arg4, void* arg5, bool arg6, void* arg7,
                                                         void* arg8))((uint64_t) skee64_info.lpBaseOfDll + 0x138450);
                        DetourTransactionBegin();
                        DetourUpdateThread(GetCurrentThread());
                        DetourAttach(&(PVOID&) SkeletonOnAttachHook, &SkeletonOnAttach_fn);
                        DetourTransactionCommit();
                        logger::info("SKEE64 0.4.20.0 parallel node transform workaround applied");
                    }
#ifdef PARALLEL_MORPH_WORKAROUND
                    logger::info("SKEE64 0.4.20.0 parallel morph workaround applying");
                    ApplyMorphsHook = (void (*)(void*, void*, void*, bool, bool))((uint64_t) skee64_info.lpBaseOfDll + 0x1cfa0);
                    DetourTransactionBegin();
                    DetourUpdateThread(GetCurrentThread());
                    DetourAttach(&(PVOID&) ApplyMorphsHook, &ApplyMorphsHook_fn);
                    DetourTransactionCommit();
                    ...
                    DetourAttach(&(PVOID&) UpdateMorphsHook, &UpdateMorphsHook_fn);
                    DetourTransactionCommit();
                    logger::info("SKEE64 0.4.20.0 parallel morph workaround applied");
#endif
#ifdef MORPHCACHE_SHRINK_WORKAROUND
                    CacheShrinkHook = (void (*)(void*))((uint64_t) skee64_info.lpBaseOfDll + 0x1d390);
                    CacheClearHook = (void (*)(void*))((uint64_t) skee64_info.lpBaseOfDll + 0x18d20);
                    Morph_vtable = ((uintptr_t) skee64_info.lpBaseOfDll + 0x1e6818);
                    logger::info("SKEE64 0.4.20.0 morphcache shrink workaround applying");
                    DetourTransactionBegin();
                    DetourUpdateThread(GetCurrentThread());
                    DetourAttach(&(PVOID&) CacheShrinkHook, &CacheShrinkHook_fn);
                    DetourTransactionCommit();
                    logger::info("SKEE64 0.4.20.0 morphcache shrink workaround applied");
#endif

                    if (skip_load == true) {
                        uintptr_t skip_load_addr = ((uintptr_t) skee64_info.lpBaseOfDll + (uintptr_t) 0xab4c0);
                        REL::safe_write(skip_load_addr, (uint8_t*) "\x48\xe9", 2);
                    ...
                    nullSkeletonFix = new SKEENullFix((uint64_t) ((uintptr_t) skee64_info.lpBaseOfDll + (uintptr_t) 0xd9a50));
                    const uint8_t* nullSkeletonCode = nullSkeletonFix->getCode();
                    REL::safe_write(((uintptr_t) skee64_info.lpBaseOfDll + (uintptr_t) 0x1e84e8), (uint8_t*) (&nullSkeletonCode),
                                    sizeof(uint64_t));
                    logger::info("SKEE64 0.4.20.0 GOG null skeleton fix applied");
#ifdef CRASH_FIX_ALPHA

                    auto deepcopy_addr = (uintptr_t) REL::ID(70191).address();
                    DeepCopyDetour =
                        (void (*)(uint64_t param_1, uint64_t* param_2, uint64_t param_3, uint64_t param_4)) REL::ID(70191).address();
                    DetourTransactionBegin();
                    DetourUpdateThread(GetCurrentThread());
                    DetourAttach(&(PVOID&) DeepCopyDetour, &DeepCopy_fn);
                    DetourTransactionCommit();
                    logger::info("SKEE64 0.4.20.0 GOG deep copy fix applied");
#endif
#ifdef DISMEMBER_CRASH_FIX_ALPHA
                    if (OverlayHook == 0x0) {
                        OverlayHook =
                            (void (*)(void* inter, uint32_t param_2, uint32_t param_3, RE::TESObjectREFR* param_4, RE::NiNode* param_5,
                                      RE::NiAVObject* param_6))((uint64_t) skee64_info.lpBaseOfDll + 0xd5fd0);
                        OverlayHook2 =
                            (void (*)(void* inter, uint32_t param_2, uint32_t param_3, RE::TESObjectREFR* param_4, RE::NiNode* param_5,
                                      RE::NiAVObject* param_6))((uint64_t) skee64_info.lpBaseOfDll + 0xd6120);
                        InstallOverlayHook = (void (*)(void* inter, const char* param_2, const char* param_3, RE::TESObjectREFR* param_4,
                                                       RE::BSGeometry* geo, RE::NiNode* param_5,
                                                       RE::BGSTextureSet* param_6))((uint64_t) skee64_info.lpBaseOfDll + 0xd41f0);
                        DetourTransactionBegin();
                        DetourUpdateThread(GetCurrentThread());
                        DetourAttach(&(PVOID&) InstallOverlayHook, &InstallOverlayHook_fn);
                        DetourTransactionCommit();
...
#endif
                    SetShaderPropertyHook = (void (*)(RE::NiAVObject* obj, void* variant, bool immediate, uint64_t arg4))(
                        (uint64_t) skee64_info.lpBaseOfDll + 0x12d310);
                    DetourTransactionBegin();
                    DetourUpdateThread(GetCurrentThread());
                    DetourAttach(&(PVOID&) SetShaderPropertyHook, &SetShaderProperty_fn);
                    DetourTransactionCommit();
                    if (PARALLEL_TRANSFORM_FIX) {
                        logger::info("SKEE64 0.4.20.0 GOG parallel node transform workaround applying");
                        nitransforminterface = (void*) (((uint64_t) skee64_info.lpBaseOfDll) + 0x2388b0);
                        UpdateNodeTransformsHook = (void (*)(void*, RE::TESObjectREFR*, bool, bool, const SKEEString* node_name))(
                            (uint64_t) skee64_info.lpBaseOfDll + 0xca7b0);
                        DetourTransactionBegin();
                        DetourUpdateThread(GetCurrentThread());
                        DetourAttach(&(PVOID&) UpdateNodeTransformsHook, &UpdateNodeTransformsHook_fn);
                        DetourTransactionCommit();
                        ...
                        SetNodeTransformsHook = (void (*)(void* arg1, uint32_t formID, uint64_t immediate, bool reset))(
                            (uint64_t) skee64_info.lpBaseOfDll + 0xcb1a0);
                        DetourTransactionBegin();
                        DetourUpdateThread(GetCurrentThread());
                        DetourAttach(&(PVOID&) SetNodeTransformsHook, &SetNodeTransformsHook_fn);
                        DetourTransactionCommit();
                        ...
                        SkeletonOnAttachHook = (void (*)(void* arg1, void* arg2, void* arg3, void* arg4, void* arg5, bool arg6, void* arg7,
                                                         void* arg8))((uint64_t) skee64_info.lpBaseOfDll + 0x138700);
                        DetourTransactionBegin();
                        DetourUpdateThread(GetCurrentThread());
                        DetourAttach(&(PVOID&) SkeletonOnAttachHook, &SkeletonOnAttach_fn);
                        DetourTransactionCommit();
                        logger::info("SKEE64 0.4.20.0 GOG parallel node transform workaround applied");
                    }
#ifdef PARALLEL_MORPH_WORKAROUND
                    logger::info("SKEE64 0.4.20.0 GOG parallel morph workaround applying");
                    ApplyMorphsHook = (void (*)(void*, void*, void*, bool, bool))((uint64_t) skee64_info.lpBaseOfDll + 0x1cfa0);
                    DetourTransactionBegin();
                    DetourUpdateThread(GetCurrentThread());
                    DetourAttach(&(PVOID&) ApplyMorphsHook, &ApplyMorphsHook_fn);
                    ...
                    DetourAttach(&(PVOID&) UpdateMorphsHook, &UpdateMorphsHook_fn);
                    DetourTransactionCommit();
                    logger::info("SKEE64 0.4.20.0 GOG parallel morph workaround applied");
#endif
#ifdef MORPHCACHE_SHRINK_WORKAROUND
                    CacheShrinkHook = (void (*)(void*))((uint64_t) skee64_info.lpBaseOfDll + 0x1d390);
                    CacheClearHook = (void (*)(void*))((uint64_t) skee64_info.lpBaseOfDll + 0x18d20);
                    Morph_vtable = ((uintptr_t) skee64_info.lpBaseOfDll + 0x1e6818);
                    logger::info("SKEE64 0.4.20.0 GOG morphcache shrink workaround applying");
                    DetourTransactionBegin();
                    DetourUpdateThread(GetCurrentThread());
                    DetourAttach(&(PVOID&) CacheShrinkHook, &CacheShrinkHook_fn);
                    DetourTransactionCommit();
                    logger::info("SKEE64 0.4.20.0 GOG morphcache shrink workaround applied");
#endif

                    if (skip_load == true) {
                        uintptr_t skip_load_addr = ((uintptr_t) skee64_info.lpBaseOfDll + (uintptr_t) 0xab790);
                        REL::safe_write(skip_load_addr, (uint8_t*) "\x48\xe9", 2);
                        logger::info("SKEE64 0.4.20.0 GOG skipping SKEE co-save loading to fix corrupted save.");
                    }
                    logger::info("SKEE64 0.4.20.0 GOG patched");
                    ...
                    if (version == REL::Version(1, 5, 97, 0)) {
                        ...
                        if (PARALLEL_TRANSFORM_FIX) {
                            ...
                            UpdateNodeTransformsHook = (void (*)(void*, RE::TESObjectREFR*, bool, bool, const SKEEString* node_name))(
                                (uint64_t) skee64_info.lpBaseOfDll + 0x7c040);
                            DetourTransactionBegin();
                            DetourUpdateThread(GetCurrentThread());
                            DetourAttach(&(PVOID&) UpdateNodeTransformsHook, &UpdateNodeTransformsHook_fn);
                            DetourTransactionCommit();
                    ...
                    if (version == REL::Version(1, 5, 97, 0)) {
                        ...
                        if (PARALLEL_TRANSFORM_FIX) {
                            ...
                            nitransforminterface = (void*) (((uint64_t) skee64_info.lpBaseOfDll) + 0x1b8af0);
                            UpdateNodeTransformsHook = (void (*)(void*, RE::TESObjectREFR*, bool, bool, const SKEEString* node_name))(
                                (uint64_t) skee64_info.lpBaseOfDll + 0x78160);
                            DetourTransactionBegin();
                            DetourUpdateThread(GetCurrentThread());
                            DetourAttach(&(PVOID&) UpdateNodeTransformsHook, &UpdateNodeTransformsHook_fn);
                            DetourTransactionCommit();
                    ...
                    if (PARALLEL_TRANSFORM_FIX) {
                        ...
                        nitransforminterface = (void*) (((uint64_t) skee64_info.lpBaseOfDll) + 0x1ce750);
                        UpdateNodeTransformsHook = (void (*)(void*, RE::TESObjectREFR*, bool, bool, const SKEEString* node_name))(
                            (uint64_t) skee64_info.lpBaseOfDll + 0x82a20);
                        DetourTransactionBegin();
                        DetourUpdateThread(GetCurrentThread());
                        DetourAttach(&(PVOID&) UpdateNodeTransformsHook, &UpdateNodeTransformsHook_fn);
                        DetourTransactionCommit();
                    ...
                    logger::info("SKEE64 U1179 GOG patching now");
                    ...
                    nullSkeletonFix = new SKEENullFix((uint64_t) ((uintptr_t) skee64_info.lpBaseOfDll + (uintptr_t) 0xa5400));
                    const uint8_t* nullSkeletonCode = nullSkeletonFix->getCode();
                    REL::safe_write(((uintptr_t) skee64_info.lpBaseOfDll + (uintptr_t) 0x19e6d0), (uint8_t*) (&nullSkeletonCode),
                                    sizeof(uint64_t));
                    logger::info("SKEE64 U1179 GOG null skeleton fix applied");
#ifdef CRASH_FIX_ALPHA
                    ...
                    DetourAttach(&(PVOID&) DeepCopyDetour, &DeepCopy_fn);
                    DetourTransactionCommit();
                    logger::info("SKEE64 U1179 GOG deep copy fix applied");
#endif
#ifdef DISMEMBER_CRASH_FIX_ALPHA
                    if (OverlayHook == 0x0) {
                        OverlayHook =
                            (void (*)(void* inter, uint32_t param_2, uint32_t param_3, RE::TESObjectREFR* param_4, RE::NiNode* param_5,
                                      RE::NiAVObject* param_6))((uint64_t) skee64_info.lpBaseOfDll + 0xa1940);
                        OverlayHook2 =
                            (void (*)(void* inter, uint32_t param_2, uint32_t param_3, RE::TESObjectREFR* param_4, RE::NiNode* param_5,
                                      RE::NiAVObject* param_6))((uint64_t) skee64_info.lpBaseOfDll + 0xa1a90);
                        InstallOverlayHook = (void (*)(void* inter, const char* param_2, const char* param_3, RE::TESObjectREFR* param_4,
                                                       RE::BSGeometry* geo, RE::NiNode* param_5,
                                                       RE::BGSTextureSet* param_6))((uint64_t) skee64_info.lpBaseOfDll + 0x9fb60);
                        DetourTransactionBegin();
                        DetourUpdateThread(GetCurrentThread());
                        DetourAttach(&(PVOID&) InstallOverlayHook, &InstallOverlayHook_fn);
                        DetourTransactionCommit();
                        ...
                        DetourAttach(&(PVOID&) OverlayHook2, &OverlayHook2_fn);
                        DetourTransactionCommit();
                        logger::info("SKEE64 U1179 GOG decapitation fix applied");
                    }

#endif
                    SetShaderPropertyHook = (void (*)(RE::NiAVObject* obj, void* variant, bool immediate, uint64_t arg4))(
                        (uint64_t) skee64_info.lpBaseOfDll + 0xf1aa0);
                    DetourTransactionBegin();
                    DetourUpdateThread(GetCurrentThread());
                    DetourAttach(&(PVOID&) SetShaderPropertyHook, &SetShaderProperty_fn);
                    DetourTransactionCommit();
                    if (PARALLEL_TRANSFORM_FIX) {
                        logger::info("SKEE64 U1179 GOG parallel node transform workaround applying");
                        nitransforminterface = (void*) (((uint64_t) skee64_info.lpBaseOfDll) + 0x1e6880);
                        UpdateNodeTransformsHook = (void (*)(void*, RE::TESObjectREFR*, bool, bool, const SKEEString* node_name))(
                            (uint64_t) skee64_info.lpBaseOfDll + 0x96880);
                        DetourTransactionBegin();
                        DetourUpdateThread(GetCurrentThread());
                        DetourAttach(&(PVOID&) UpdateNodeTransformsHook, &UpdateNodeTransformsHook_fn);
                        DetourTransactionCommit();
                        ...
                        DetourAttach(&(PVOID&) SkeletonOnAttachHook, &SkeletonOnAttach_fn);
                        DetourTransactionCommit();
                        logger::info("SKEE64 U1179 GOG parallel node transform workaround applied");
                    }
#ifdef PARALLEL_MORPH_WORKAROUND
                    logger::info("SKEE64 U1179 parallel morph workaround applying");
                    ApplyMorphsHook = (void (*)(void*, void*, void*, bool, bool))((uint64_t) skee64_info.lpBaseOfDll + 0xf7f0);
                    DetourTransactionBegin();
                    DetourUpdateThread(GetCurrentThread());
                    DetourAttach(&(PVOID&) ApplyMorphsHook, &ApplyMorphsHook_fn);
                    DetourTransactionCommit();
                    UpdateMorphsHook = (void (*)(void*, void*, void*))((uint64_t) skee64_info.lpBaseOfDll + 0x9e70);
                    DetourTransactionBegin();
                    DetourUpdateThread(GetCurrentThread());
                    DetourAttach(&(PVOID&) UpdateMorphsHook, &UpdateMorphsHook_fn);
                    DetourTransactionCommit();
                    logger::info("SKEE64 U1179 parallel morph workaround applied");
#endif
#ifdef MORPHCACHE_SHRINK_WORKAROUND
                    CacheShrinkHook = (void (*)(void*))((uint64_t) skee64_info.lpBaseOfDll + 0xfb10);
                    CacheClearHook = (void (*)(void*))((uint64_t) skee64_info.lpBaseOfDll + 0xbfa0);
                    Morph_vtable = ((uintptr_t) skee64_info.lpBaseOfDll + 0x19ba98);
                    logger::info("SKEE64 U1179 morphcache shrink workaround applying");
                    DetourTransactionBegin();
                    DetourUpdateThread(GetCurrentThread());
                    DetourAttach(&(PVOID&) CacheShrinkHook, &CacheShrinkHook_fn);
                    DetourTransactionCommit();
                    logger::info("SKEE64 U1179 morphcache shrink workaround applied");
#endif

                    if (skip_load == true) {
                        uintptr_t skip_load_addr = ((uintptr_t) skee64_info.lpBaseOfDll + (uintptr_t) 0x79449);
                        REL::safe_write(skip_load_addr, (uint8_t*) "\x48\xe9", 2);
                        logger::info("SKEE64 U1179 skipping SKEE co-save loading to fix corrupted save.");
                    }
            ...
            if (skee_loaded.compare_exchange_strong(expected, 1) == true && expected == 0) {
                ...
                if ((skee64_info.SizeOfImage >= 0x16bce8 + 7) &&
                    ...
                    if (PARALLEL_TRANSFORM_FIX) {
                        ...
                        nitransforminterface = (void*) (((uint64_t) skee64_info.lpBaseOfDll) + 0x1b5920);
                        UpdateNodeTransformsHook = (void (*)(void*, RE::TESObjectREFR*, bool, bool, const SKEEString* node_name))(
                            (uint64_t) skee64_info.lpBaseOfDll + 0x75350);
                        DetourTransactionBegin();
                        DetourUpdateThread(GetCurrentThread());
                        DetourAttach(&(PVOID&) UpdateNodeTransformsHook, &UpdateNodeTransformsHook_fn);
                        DetourTransactionCommit();
                    ...
                    if (PARALLEL_TRANSFORM_FIX) {
                        ...
                        nitransforminterface = (void*) (((uint64_t) skee64_info.lpBaseOfDll) + 0x1c21d0);
                        UpdateNodeTransformsHook = (void (*)(void*, RE::TESObjectREFR*, bool, bool, const SKEEString* node_name))(
                            (uint64_t) skee64_info.lpBaseOfDll + 0x7cd40);
                        DetourTransactionBegin();
                        DetourUpdateThread(GetCurrentThread());
                        DetourAttach(&(PVOID&) UpdateNodeTransformsHook, &UpdateNodeTransformsHook_fn);
                        DetourTransactionCommit();
        ...
        if (mu_normal_setskin_workaround && setskin_workaround_applied == false) {
            {
                if (auto VM = RE::BSScript::Internal::VirtualMachine::GetSingleton()) {
                    ...
                    VM->GetScriptObjectTypeNoLoad1(RE::BSFixedString("MuDynamicNormalMap"), classInfoPtr);
                    if (classInfoPtr) {
            ...
            }
            {
                if (auto VM = RE::BSScript::Internal::VirtualMachine::GetSingleton()) {
                    RE::BSTSmartPointer<RE::BSScript::ObjectTypeInfo> classInfoPtr = nullptr;
                    VM->GetScriptObjectTypeNoLoad1("ActorBase", classInfoPtr);
                    if (classInfoPtr) {
            ...
            setskin_workaround_applied = true;
        }
        /*
